...
public class Gestion_RadicacionAnular extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        ventanaInterna_Nombre.setText("BUSCAR DOCUMENTOS");
        ...
        VentanaInternaBuscarDocumento.getContentPane().add(limpiarDocumento, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 40, 150, 30));
        ...
        VentanaInternaBuscarDocumento.getContentPane().add(cancelarDocumento, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 40, 150, 30));
        ...
        VentanaInternaBuscarDocumento.getContentPane().add(buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 40, 150, 30));

        add(VentanaInternaBuscarDocumento, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 1300, 670));
