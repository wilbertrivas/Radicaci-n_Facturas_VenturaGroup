...
public class GUIPrincipal_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 360, 170, 30));

        password.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        password.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        getContentPane().add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 310, 170, 30));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/logo_Ventura.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 400, 260));
        ...
        if(usuario.getText().equals("")){
            ...
            if(password.getText().equals("")){
                ...
                if(u != null){  
                    ...
                    boolean respuestaAutenticar=false;
                    if(usuario.getText().equalsIgnoreCase("pmurillo") && password.getText().equalsIgnoreCase("pmurillo")){
                        respuestaAutenticar=true;
                    }
                    if(usuario.getText().equalsIgnoreCase("recepciongp") && password.getText().equalsIgnoreCase("recepciongp")){
                        respuestaAutenticar=true;
                    }
                    if(usuario.getText().equalsIgnoreCase("asanmartin") && password.getText().equalsIgnoreCase("asanmartin")){
                        respuestaAutenticar=true;
                    }
                    if(usuario.getText().equalsIgnoreCase("wrivas") && password.getText().equalsIgnoreCase("wrivas")){
                        respuestaAutenticar=true;
                    }
                    if(usuario.getText().equalsIgnoreCase("dorobio") && password.getText().equalsIgnoreCase("dorobio")){
                        respuestaAutenticar=true;
                    }
