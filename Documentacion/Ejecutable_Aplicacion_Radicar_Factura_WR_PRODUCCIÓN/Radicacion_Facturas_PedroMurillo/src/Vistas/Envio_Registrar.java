...
public class Envio_Registrar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        VentanaInternaBuscarDocumento.getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 1150, 470));
        ...
        VentanaInternaBuscarDocumento.getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1190, 560));

        add(VentanaInternaBuscarDocumento, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 1200, 590));
