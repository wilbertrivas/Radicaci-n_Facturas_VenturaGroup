...
public class Informe_Generar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        VentanaInternaEmpresa.setVisible(true);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vistas/Img/Fondo.png"))); // NOI18N
        VentanaInternaEmpresa.getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1290, 600));

        add(VentanaInternaEmpresa, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 600, 1300, 630));
        ...
        VentanaInternaProveedor.getContentPane().add(limpiarProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, 140, 40));
        ...
        VentanaInternaProveedor.getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 1190, 440));
        ...
        VentanaInternaProveedor.getContentPane().add(buscarProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 140, 40));
        ...
        VentanaInternaProveedor.getContentPane().add(cancelarProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 90, 160, 40));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vistas/Img/Fondo.png"))); // NOI18N
        VentanaInternaProveedor.getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1290, 600));

        add(VentanaInternaProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 600, 1300, 630));
        ...
        generarDocumento.setText("GENERAR DOCUMENTO");
    ...
    public void tabla_Informe_General(String valorConsulta) throws SQLException{
        ...
        String [] titulo= {"IdHistorico","idDocumento","No. Factura","Nit_Proveedor", "Nombre_Proveedor" ,"EstadoHistorico","EstadoDocumento","Usuario_Origen"
                ,"Usuario_Destino","Empresa_Destino","Sede","Fecha_Registro","Fecha_Anulacion","Observacion_Anulacion"};    
        modelo = new DefaultTableModel(null, titulo);
        ...
        for(int i =0; i< listadoConsultaGeneralInforme.size(); i++){
            ...
            registro[12]=""+listadoConsultaGeneralInforme.get(i).getDocumento_fechaAnulacion_documento();
            registro[13]=""+listadoConsultaGeneralInforme.get(i).getDocumento_observacionAnulacion_documento();
            modelo.addRow(registro);
