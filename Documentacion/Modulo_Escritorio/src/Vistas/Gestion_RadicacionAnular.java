...
public class Gestion_RadicacionAnular extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(VentanaInternaBuscarDocumento, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 1300, 670));
        ...
        add(mensaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 310, 740, 30));
        ...
        add(Registrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 340, 130, 30));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 190, 580, 120));
        ...
        if(documentoId.getText().equals("")){
           mensaje.setText("Debe cargar un documento Para Anularlo");
            ...
            if(observacion.getText().equals("")){
                ...
                String observacionD="Usuario Quien Anula: "+user.getId_usuario()+" Motivo Anulación: "+observacion.getText();
